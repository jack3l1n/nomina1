...
<div class="form">
    ...
    <div class="row">
        ...
        <?php
        echo $form->dropDownlist($model, 'id_Cargo', array('---' => '---', 
             
            
            'ASISTENTE GERENCIA' => 'ASISTENTE GERENCIA',
            'ASESOR COMERCIAL' => 'ASESOR COMERCIAL',
            'AUXILIAR CONTABLE' => 'AUXILIAR CONTABLE',
            'AUXILIAR CARTERA' => 'AUXILIAR CARTERA',
            'AUXILIAR INVENTARIOS' => 'AUXILIAR INVENTARIOS',
            'AUXILIAR RH' => 'AUXILIAR RH',
            'AUXILIAR BODEGA' => 'AUXILIAR BODEGA',
            'AUX BODEGA ALMACEN' => 'AUX BODEGA ALMACEN',
            'ADMINISTRADOR ALMACEN' => 'ADMINISTRADOR ALMACEN',
            'ADMINISTRADOR SUPLENTE ALMACEN' => 'ADMINISTRADOR SUPLENTE ALMACEN',
            'CAJERA ALMACEN' => 'CAJERA  ALMACEN',
            'CONTADOR' => 'CONTADOR',
            'EJECUTIVO COMERCIAL' => 'EJECUTIVO COMERCIAL',
            'JEFE CARTERA' => 'JEFE CARTERA',
            'JEFE INVENTARIOS' => 'JEFE INVENTARIOS',
            'JEFE RH' => 'JEFE RH',
            'JEFE SISTEMAS' => 'JEFE SISTEMAS',
            'JEFE MERCADEO' => 'JEFE MERCADEO',
    ...
    <div class="row">
        ...
        <?php
        echo $form->dropDownlist($model, 'id_Sucursal', array('---' => '---', 'ALM CALLE 169' => 'ALM CALLE 169',
            ...
            'ALM VILLAVICENCIO' => 'ALM VILLAVICENCIO', 'ALM_ARMENIA' => 'ALM_ARMENIA', 'ALM_CHIA' => 'ALM_CHIA', 'ADMINISTRACION' => 'ADMINISTRACION', 'INGENIERIA' => 'INGENIERIA', 'BODEGA' =>'BODEGA'));
        ?>
        <?php echo $form->error($model, 'id_Sucursal'); ?>
    </div>
