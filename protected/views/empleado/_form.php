    ...
    <div class="j1">
        ...
        <div class="row">
            ...
            <?php echo $form->labelEx($model, 'telefono');  ?>
                ...
                <div class="row">
                    <?php echo $form->labelEx($model, 'fotoprincipal'); ?>
                    <?php echo $form->textField($model, 'fotoprincipal'); ?>
                    <?php echo $form->error($model, 'fotoprincipal'); ?>
                </div>
            ...
            <div class="row">
                ...
                <?php echo $form-> dropDownlist($model, 'sucursal', array( '---' => '---', 'ALM CALLE 169' => 'ALM CALLE 169',
